        ...
        {categories.map((cat, i) => (
          <FadeIn key={cat.slug} delay={i * 50}>
            <Link
              ...
              className="group relative block h-48 overflow-hidden rounded-3xl transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/5"
            >
              <Image
                src={cat.cover}
                alt=""
